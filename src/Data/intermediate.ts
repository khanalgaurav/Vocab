...
const words: Word[] = [
  ...
  },
  {
    ...
    example:
      "After he applies the metal to the canvas, he burnishes and glazes it.",
    language: "en",
  },
  {
    word: "chasten",
  ...
  },
  {
    ...
    example:
      "All the characters feel compelled — constantly, frenetically — to dissemble, lie and pretend to be what they are not.",
    language: "en",
  },
  {
    word: "disseminate",
  ...
  },
  {
    ...
    example:
      "The Japanese occupation of the Aleutian Islands was one of the least-known aspects of World War II, thanks to a U.S. government censorship campaign designed to forestall civilian panic about enemy encroachment on American soil.",
    language: "en",
  },
  {
    word: "ideological",
  ...
  },
  {
    ...
    example:
      "But beyond these aggrieved hordes, it can seem at times as if nearly everyone in the country is nursing wounds, cringing over slights and embarrassments, inveighing against enemies and wishing for retribution.",
    language: "en",
  },
  {
    word: "irresolute",
  ...
  },
  {
    ...
    example:
      "I hold these things up as talismans to protect me; all my awards are thin paper shields to keep me safe from the hatred that surrounds me and my friends.",
    language: "en",
  },
  {
    word: "amalgamate",
  ...
  },
  {
    ...
    example:
      "All Woolly rhino images consistently show a massively deep, hugely convex shoulder hump that extends all the way forward to the back of the head.",
    language: "en",
  },
  {
    word: "discrepancy",
  ...
  },
  {
    ...
    example:
      "Rebels—active fighters and dissidents—were viewed as a threat, and an undetermined number were deported as indentured laborers to the West Indies to work on sugar plantations.",
    language: "en",
  },
  {
    word: "efficacious",
    ...
    example:
      "By analyzing the time to an infection after a person received the monoclonals, the scientists found that the high dose was 88% efficacious in preventing infection and the low dose 75% efficacious, compared to placebo.",
    language: "en",
  },
  {
    word: "emaciated",
    ...
    example:
      "Inside the overcrowded barracks, starving prisoners lay crammed together on the platforms, their eyes glazed over, their emaciated bodies barely able to move.",
    language: "en",
  },
  {
    word: "enunciate",
  ...
  },
  {
    ...
    example:
      "The etymology of “person” traces back to the Latin persona, meaning mask, especially the type worn by actors or those playing social roles.",
    language: "en",
  },
  {
    word: "facetious",
  ...
  },
  {
    ...
    example:
      "Sitting across a desk from the famous and powerful, he was friendly but not fawning, interested but never obsequious.",
    language: "en",
  },
  {
    word: "piquant",
    ...
    example:
      "Fermented shrimp paste, or belacan, typically dehydrated and packaged as a compact cake, is a key ingredient in many of Malaysia's slew of piquant dishes.",
    language: "en",
  },
  {
    word: "sobriety",
  ...
  },
  {
    ...
    definition: "show off",
    example:
      "He vaunts aloud that “his blacks” in South Africa are well fed and materially better off under the chains of apartheid than their liberated brothers and sisters in the rest of Africa.",
    language: "en",
  },
  {
    word: "adulterate",
  ...
  },
  {
    ...
    example:
      "I never thought of the Erudite as being particularly perceptive about relationships, or emotions, but Cara’s discerning eyes see all kinds of things.",
    language: "en",
  },
  {
    word: "egoism",
  ...
  },
  {
    ...
    example:
      "Magna Carta recognizes that even kings must defer to a “law of the land”; that justice emerges from procedure, not fiat; and that “free men” merited guarantees we would now call “rights.”",
    language: "en",
  },
  {
    word: "glib",
  ...
  },
  {
    ...
    example:
      "They were very successful within the current Broadway trend of making insipid, boring, un-creative and overproduced versions of classic movies.",
    language: "en",
  },
  {
    word: "interdict",
  ...
  },
  {
    ...
    example:
      "Although he claimed, for instance, that he only wanted to honor a playwright’s work, he often meddled with the scripts — his “Ghosts” interpolated Ibsen’s text with some Strindberg.",
    language: "en",
  },
  {
    word: "junta",
    ...
    example:
      "Haitians had been hopeful after Baby Doc Duvalier and his secret police had been chased from power, yet the military leaders of the new junta were even more brutal.",
    language: "en",
  },
  {
    word: "laconic",
  ...
  },
  {
    ...
    example:
      "But the humans in this equation remain a significant cost, and innovators are looking to obviate them with automated solutions.",
    language: "en",
  },
  {
    word: "physiognomy",
    ...
    example:
      "His figures are ugly not because of their physiognomy, but because they behave in ugly ways: They don’t look, they leer; they don’t smile, they smirk.",
    language: "en",
  },
  {
    word: "proliferate",
    ...
    example:
      "Faced with millions of refugees, the new nations of South Asia ended up proliferating developments that doubled down on centuries of class division.",
    language: "en",
  },
  {
    word: "regale",
    ...
    example:
      "He regaled us with stories of his trips to Johannesburg, a place none of us had ever been before.",
    language: "en",
  },
  {
    word: "tortuous",
  ...
  },
  {
    ...
    example:
      "For a baby, there are structures underlying language that are tractable and learnable from the information available in the environment.",
    language: "en",
  },
  {
    word: "variegated",
  ...
  },
  {
    ...
    example:
      "Working indoors in cooler environments helps ameliorate some of the problems, of course, but the physiological effects of heat don't immediately disappear the moment a student walks into some full blast AC.",
    language: "en",
  },
  {
    word: "assuage",
    ...
    example:
      "Calm medical explanations did nothing to assuage the son’s anxiety.",
    language: "en",
  },
  {
    word: "complaisant",
  ...
  },
  {
    ...
    example:
      "His belly was concave, and his skin pressed against his rib cage.",
    language: "en",
  },
  {
    word: "denizen",
  ...
  },
  {
    ...
    example:
      "We remove one biological reserve here, we extirpate a series of species there, we pollute, we fragment, we introduce invasive species, all to the point of eventual catastrophe.",
    language: "en",
  },
  {
    word: "foment",
  ...
  },
  {
    ...
    example:
      "To the supplications of reason they eventually added the insult of imprecation, calling him a young cur and a scoundrel and, moreover, a fool.",
    language: "en",
  },
  {
    word: "limpid",
    ...
    example:
      "His prose is as clear and limpid as water, his ear finely attuned to the timbre of the period though mercifully free from archaisms, his characters drawn with subtlety and wit.",
    language: "en",
  },
  {
    word: "miscreant",
    ...
    example:
      "For a movie about ethics that repeatedly emphasizes “morality,” “The Truth About Lies” doesn’t judge assorted miscreants who tell their tales of being caught lying and facing the consequences.",
    language: "en",
  },
  {
    word: "obdurate",
  ...
  },
  {
    ...
    example:
      "History writes Emily Dickinson as a recluse who only published about 10 of her hundreds of poems while she was alive and rarely if ever left her room.",
    language: "en",
  },
  {
    word: "refractory",
  ...
  },
  {
    ...
    example:
      "Without better data, we can’t have a substantive discussion about which interventions are most effective and consistent with our values.",
    language: "en",
  },
  {
    word: "vortex",
  ...
  },
  {
    ...
    example:
      "His most famous work, the glass pyramid outside the Louvre, is still an adjunct—albeit an iconic one—to the world’s most famous museum of art.",
    language: "en",
  },
  {
    word: "conjugal",
    ...
    example:
      "Rather, its aim was to encourage conjugal felicity: the show's theme song went \"Mr and Mrs, be nice to each other / Mr and Mrs, we've got to love one another\".",
    language: "en",
  },
  {
    word: "dearth",
    ...
    example:
      "If there was a dearth of tailored jackets, regular tailored trousers had also all but disappeared, shrunk into ultra-skinny pants.",
    language: "en",
  },
  {
    word: "diffidence",
  ...
  },
  {
    ...
    example:
      "When he saw machinery lying fallow, he cited it as proof that Haiti has equipment but needs more skills, and he made a mental note to work on vocational schools.",
    language: "en",
  },
  {
    word: "frieze",
  ...
  },
  {
    ...
    example:
      "It’s the stuff of tragedy, yet it would be a mistake to take any of the plot machinations—who is backstabbing whom, which corporate power play will win out—too seriously.",
    language: "en",
  },
  {
    word: "menagerie",
    ...
    example:
      "For her part, Rosie is carted out through each town in the hippopotamus wagon and then displayed in the menagerie.",
    language: "en",
  },
  {
    word: "mendicant",
    ...
    example:
      "Friday is a special day of charity for Muslims, and crippled mendicants are much in evidence.",
    language: "en",
  },
  {
    word: "officious",
  ...
  },
  {
    ...
    example:
      "Charlotte's body plummets toward the ground like a star falling from the heavens.",
    language: "en",
  },
  {
    word: "prate",
  ...
  },
  {
    ...
    example:
      "Researchers increasingly are finding a causal relationship between heavy-duty truck emissions and respiratory ailments such as asthma.",
    language: "en",
  },
  {
    word: "clairvoyant",
    ...
    example:
      "She was struck by a clairvoyant vision — a voice, really, that warned her of a fight that was about to occur over the price of the bananas.",
    language: "en",
  },
  {
    word: "credence",
  ...
  },
  {
    ...
    example:
      "This literary study of mankind’s transition from hunted to hunter connects the pursuit of prey to the pursuit of knowledge; Calasso’s encyclopedic erudition yields fascinating meditations on mythology and classical antiquity.",
    language: "en",
  },
  {
    word: "filibuster",
    ...
    example:
      "The filibuster is well known for being a tool of segregationists trying to block various civil rights bills in the 1950s and 1960s.",
    language: "en",
  },
  {
    word: "flout",
    ...
    example:
      "There were rules that had to be followed, and people didn’t take it kindly when you flouted them.",
    language: "en",
  },
  {
    word: "gainsay",
  ...
  },
  {
    ...
    example:
      "He’s a paragon of excellence, the night-after-night dependability that made him a sensation on Broadway, where a person needs an entertainer’s soul and an athlete’s hustle to get by.",
    language: "en",
  },
  {
    word: "precursor",
  ...
  },
  {
    ...
    example:
      "Over in the frozen meadow, a satyr skidded on his hooves as he chased after a redheaded tree nymph.",
    language: "en",
  },
  {
    word: "untoward",
  ...
  },
  {
    ...
    example:
      "All objects in the universe exert a gravitational tug in proportion to their mass, and it attenuates across distances.",
    language: "en",
  },
  {
    word: "condone",
  ...
  },
  {
    ...
    example:
      "Although ants—hornets' relatives—are estimated to spread seeds for more than 11,000 plants, the study notes, documented cases of hornets themselves doing so are rare.",
    language: "en",
  },
  {
    word: "fatuous",
    ...
    example:
      "The best poet of the 20th century knew that the idea of “having it all” was nonsense before anybody ever dreamed up such a fatuous phrase.",
    language: "en",
  },
  {
    word: "impervious",
  ...
  },
  {
    ...
    example:
      "Instead, he noted the military study was “designed to lay to rest the wild speculation” about radiation victims in the devastated city and proceeded to substantiate the human suffering with hard facts.",
    language: "en",
  },
  {
    word: "sylvan",
    ...
    example:
      "The tulip poplars and oaks in the forest beyond the fence and water coursing over the edge of the pool summon a sylvan atmosphere.",
    language: "en",
  },
  {
    word: "virtuoso",
  ...
  },
  {
    ...
    example:
      "The big thing back then was something called “desktop publishing” and now the very idea of printing anything seems like an anachronism.",
    language: "en",
  },
  {
    word: "anomalous",
  ...
  },
  {
    ...
    example:
      "Maybe you grew up poor, so now you’re a spendthrift, but your spending frustrates your frugal spouse, so you think winning the lottery will fix the issue.",
    language: "en",
  },
  {
    word: "strident",

const words = [
  ...
  },
  {
    ...
    example:
      "Foucault’s maxim is relevant for anyone interested in the arts, but particularly apposite for critics, who are obliged to perceive and reflect quickly, relying on deeply grooved instincts and memories.",
    language: "en",
  },
  {
    word: "bovine",
  ...
  },
  {
    ...
    example:
      "The viral response has combined a sudden uptick in civic responsibility with widespread dissonance about how much of it is needed, making the perfect recipe for discord.",
    language: "en",
  },
  {
    word: "doctrinaire",
  ...
  },
  {
    ...
    example:
      'His life in Southern California in the 1950s and early \'60s sounds in many ways halcyon, full of beach gear and Volkswagen buses and wharf rats and characters with "PhDs in having fun."',
    language: "en",
  },
  {
    ...
    example:
      "Would it come into the world gossiping and nattering on about inconsequential nothings?",
    language: "en",
  },
  {
    word: "militate",
    ...
    example:
      "In patrilineal Yoruba societies, where men claimed most positions of political power, women claimed the power of witchcraft to “use that power against the institutions of society” and “militate against … total male dominance.”",
    language: "en",
  },
  {
    word: "misanthrope",
  ...
  },
  {
    ...
    example:
      "The glass bowl shattered along the circular depression in its middle, leaving me with a jagged sickle of a shard.",
    language: "en",
  },
  {
    word: "stultify",
  ...
  },
  {
    ...
    example:
      "The clay was shoveled into one of the pits and water mixed in to form a thick viscous mud.",
    language: "en",
  },
  {
    word: "abscission",
  ...
  },
  {
    ...
    example:
      "Despite the carping of younger critics, he remained ever faithful to his Romantic Realist principles.",
    language: "en",
  },
  {
    word: "cornucopia",
  ...
  },
  {
    ...
    example:
      "Food souvenirs are food, but they’re also souvenirs, and as such are evocative of people and places.",
    language: "en",
  },
  {
    word: "extemporaneous",
    ...
    example:
      "Many of the app’s users appear charmingly unpolished, posting shaky videos that cut their faces off at their foreheads or chins as they deliver breathless extemporaneous monologues.",
    language: "en",
  },
  {
    word: "feral",
  ...
  },
  {
    ...
    example:
      "Oliver Cromwell headed the new English Commonwealth, and the period known as the English interregnum, or the time between kings, began.",
    language: "en",
  },
  {
    word: "meretricious",
  ...
  },
  {
    ...
    example:
      "And thus the writer’s euphoric westward peregrinations, by motor car, kindled a new spirit of domestic US travel: On the Road rather than On the Railroad.",
    language: "en",
  },
  {
    word: "preempt",
  ...
  },
  {
    ...
    example:
      "Those monkeys had been infected with simian fever and would have died anyway.",
    language: "en",
  },
  {
    word: "tangential",
  ...
  },
  {
    ...
    example:
      "He appears as the protector of his younger self and as a kind of tutelary deity, infusing the story of his own life with a potent and implicitly political lesson.",
    language: "en",
  },
  {
    word: "valedictory",
    ...
    example:
      "There was no farewell tour, and they released a valedictory song — “We All Go Back to Where We Belong” — that is among the most beautiful in the band’s catalog.",
    language: "en",
  },
  {
    word: "centripetal",
